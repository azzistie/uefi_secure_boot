...
#define EFI_PKCS7_VERIFY_PROTOCOL_GUID EFI_GUID(0x47889fb2, 0xd671, 0x4fab, 0xa0, 0xca, 0xdf, 0x0e, 0x44, 0xdf, 0x70, 0xd6)
...
typedef
efi_status_t
(__attribute((ms_abi)) *EFI_PKCS7_VERIFY_BUFFER)(
  EFI_PKCS7_VERIFY_PROTOCOL    *This,
  void                         *SignedData,
  unsigned int                        SignedDataSize,
  void                         *InData          ,
  unsigned int                        InDataSize,
  efi_signature_list_t           **AllowedDb,
  efi_signature_list_t           **RevokedDb      ,
  efi_signature_list_t           **TimeStampDb    ,
  void                        *Content         ,
...
typedef
efi_status_t
(__attribute__((ms_abi)) *EFI_PKCS7_VERIFY_SIGNATURE)(
  EFI_PKCS7_VERIFY_PROTOCOL   *This,
  void                        *Signature,
  unsigned int                       SignatureSize,
  void                        *InHash,
  unsigned int                       InHashSize,
  efi_signature_list_t          **AllowedDb,
  efi_signature_list_t          **RevokedDb       ,
  efi_signature_list_t          **TimeStampDb     
  );
...
typedef struct _EFI_PKCS7_VERIFY_PROTOCOL_32_t EFI_PKCS7_VERIFY_PROTOCOL_32_t;
typedef
efi_status_t
(*EFI_PKCS7_VERIFY_BUFFER_32_t)(
  EFI_PKCS7_VERIFY_PROTOCOL_32_t    *This,
  void                         *SignedData,
  unsigned int                        SignedDataSize,
  void                         *InData          ,
  unsigned int                        InDataSize,
...
typedef
efi_status_t
(*EFI_PKCS7_VERIFY_SIGNATURE_32_t)(
  EFI_PKCS7_VERIFY_PROTOCOL_32_t   *This,
  void                        *Signature,
  unsigned int                       SignatureSize,
  void                        *InHash,
...
struct _EFI_PKCS7_VERIFY_PROTOCOL_32_t {
  EFI_PKCS7_VERIFY_BUFFER_32_t       VerifyBuffer;
  EFI_PKCS7_VERIFY_SIGNATURE_32_t    VerifySignature;
};


typedef struct _EFI_PKCS7_VERIFY_PROTOCOL_64_t EFI_PKCS7_VERIFY_PROTOCOL_64_t;
typedef
efi_status_t
(*EFI_PKCS7_VERIFY_BUFFER_64_t)(
  EFI_PKCS7_VERIFY_PROTOCOL_64_t    *This,
  void                         *SignedData,
  unsigned int                        SignedDataSize,
  void                         *InData          ,
  unsigned int                        InDataSize,
...
typedef
efi_status_t
(*EFI_PKCS7_VERIFY_SIGNATURE_64_t)(
  EFI_PKCS7_VERIFY_PROTOCOL_64_t   *This,
  void                        *Signature,
  unsigned int                       SignatureSize,
  void                        *InHash,
...
struct _EFI_PKCS7_VERIFY_PROTOCOL_64_t {
  EFI_PKCS7_VERIFY_BUFFER_64_t       VerifyBuffer;
  EFI_PKCS7_VERIFY_SIGNATURE_64_t    VerifySignature;
};
